...
public class SmsService {
	...
	public void sendSMS(String tel,String msg,String berthName) {
		...
		String accessKey = "6my6e2DaExctaAzRdPSp";                     	// 네이버 클라우드 플랫폼 회원에게 발급되는 개인 인증키			// Access Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID
		String secretKey = "yUpb88rLqx0wtikFDMjpR3Z1NsEAZeJqRzEwiRvO";  // 2차 인증을 위해 서비스마다 할당되는 service secret key	// Service Key : https://www.ncloud.com/mypage/manage/info > 인증키 관리 > Access Key ID	
		String serviceId = "ncp:sms:kr:315294716724:ezen_final_sms";       // 프로젝트에 할당된 SMS 서비스 ID							// service ID : https://console.ncloud.com/sens/project > Simple & ... > Project > 서비스 ID
