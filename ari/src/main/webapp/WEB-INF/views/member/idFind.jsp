...
<div class="login-wrap">
  ...
  <div class="group">
  	<input type="text" required name="usertel" id="usertel" class="input" placeholder="휴대폰번호(-없이 숫자만 입력)" oninput="onlynum(this)" maxlength ="11">&nbsp;<input type="button" class="btn2" value="인증번호 받기" onclick = "sendMsg()">
  </div>
  ...
  <div class="group">
    <input type="submit" class="btn1" value="아이디 찾기" onclick = "formCheck(${userType})">
  </div>
  </form>
  </div>
 </div>
