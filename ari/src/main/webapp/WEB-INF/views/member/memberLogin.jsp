...
<div class="login-wrap">
  ...
  <div class="kakaoDiv">
  	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=3623a44fed0e1055e089acc18ec7aacf&redirect_uri=http://192.168.0.31:9000//oauth/kakao&response_type=code"><button type="button" class="kakaoBtn"><img src="/img/kakao_login_medium_wide.png" alt="카카오로그인" class="kakaoImg"></button>
  	</a>
  <div class="group">
