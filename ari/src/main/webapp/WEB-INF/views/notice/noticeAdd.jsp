		...
		<div class="content4">	
		  <div class="mb-3 row">
		    ...
		    <div class="col-sm-10 margint" style="padding-left:35px;">
			  ...
			  <div class="marginl">
			  	<input type="text" maxlength="33" class="form-control contentwidth border1" name="noticetitle" id="exampleFormControlInput1" placeholder="공지사항 제목">
			  </div>
			  <label for="staticEmail" class="col-sm-2 col-form-label">내용</label>
			  <div class="marginl margint">
			  	<textarea class="form-control border1 content3" maxlength="1000" name="noticecontent" id="exampleFormControlTextarea1" ></textarea>
